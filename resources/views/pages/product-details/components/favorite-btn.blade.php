<button class="group transition-all duration-500 p-0.5">
    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle class="fill-green-50 transition-all duration-500 group-hover:fill-green-100" cx="30" cy="30"
            r="30" fill="" />
        <path class="stroke-green-600 transition-all duration-500 group-hover:stroke-green-700"
            ...
            stroke="" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
</button>
